...
// Hardware Config:
// Light 1:
//  M0PWM2 (PB4) controls the ___ colored light on the LED strip
// Light 2:
//  M0PWM3 (PB5) controls the ___ colored light on the LED strip
// Light 3:
//  M0PWM4 (PE4) controls the ___ colored light on the LED strip
...
int main(void)
{
    ...
    while(true)
    {
        setPwmDutyCycle(0, 254);
        waitMicrosecond(1000000);
        setPwmDutyCycle(0,0);
        setPwmDutyCycle(1, 254);
        waitMicrosecond(1000000);
        setPwmDutyCycle(1,0);
        setPwmDutyCycle(2, 254);
        waitMicrosecond(1000000);
        setPwmDutyCycle(3,0);
    }
}
